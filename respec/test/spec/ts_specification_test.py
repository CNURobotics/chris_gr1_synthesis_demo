...
class SpecificationConstructionTests(unittest.TestCase):
    ...
    def test_formulas_in_env_trans(self):
        ...
        # mutex
        expected_formulas_1 = [expected_formula_1a, expected_formula_1b, expected_formula_1c]

        expected_formula_2a = '(r1_c & (r1_a & ! r2_a & ! r3_a)) -> (next(r1_c) | next(r1_f))'
        expected_formula_2b = ('(r1_c & (r2_a & ! r1_a & ! r3_a)) -> '
                               '(next(r1_c) | next(r2_f) | next(r2_c))')

        expected_formula_2c = ('(r1_c & (r3_a & ! r1_a & ! r2_a)) -> '
                               '(next(r3_c) | next(r3_f) | next(r1_c))')

        expected_formula_2d = '(r2_c & (r2_a & ! r1_a & ! r3_a)) -> (next(r2_f) | next(r2_c))'
        expected_formula_2e = ('(r3_c & (r1_a & ! r2_a & ! r3_a)) -> '
                               '(next(r3_c) | next(r1_c) | next(r1_f))')
        ...
        expected_formulas_3 = [expected_formula_3d, expected_formula_3e, expected_formula_3f,
                               expected_formula_3g, expected_formula_3h, expected_formula_3i]
        #                               constrain failure
        ...
        # outcome persistence
        expected_formulas_5 = [expected_formula_5a, expected_formula_5b, expected_formula_5c,
    ...
    def test_formulas_in_sys_trans(self):
        ...
        expected_formula_1 = ('next(r1_c) -> ('
                              'next(r1_a & ! r2_a & ! r3_a) | '
                              'next(r2_a & ! r1_a & ! r3_a) | '
                              'next(r3_a & ! r1_a & ! r2_a) | '
                              'next(! r1_a & ! r2_a & ! r3_a))')
        expected_formula_2 = ('next(r2_c) -> ('
                              'next(r2_a & ! r1_a & ! r3_a) | '
                              'next(! r1_a & ! r2_a & ! r3_a))')
        expected_formula_3 = ('next(r3_c) -> ('
                              'next(r3_a & ! r1_a & ! r2_a) | '
                              'next(r1_a & ! r2_a & ! r3_a) | '
                              'next(! r1_a & ! r2_a & ! r3_a))')
        ...
        #                               transition relation
        expected_sys_trans = [expected_formula_1, expected_formula_2, expected_formula_3,
                              expected_formula_4a, expected_formula_4b, expected_formula_4c]
        #                               deactivation
    ...
    def test_formulas_in_env_liveness(self):
        ...
        expected_formula_1 = '({} | {} | {})'.format(
            expected_formula_1a, expected_formula_1b, expected_formula_1c)  # completion
        ...
        #                          expected_formula_2 + ' | ' + \
        #                          expected_formula_3 + ')'
        expected_env_liveness = '(' + expected_formula_1 + ' | ' + expected_formula_3 + ')'
