...
from ...respec.formula.activation_outcomes import (
    OutcomeMutexFormula,
    FailedOutcomeFormula,
    PreconditionsFormula,
    TopologyMutexFormula,
    SingleStepChangeFormula,
    SystemInitialConditions,
    RetryAfterFailureFormula,
    SuccessfulOutcomeFormula,
    ActivationOutcomesFormula,
    TransitionRelationFormula,
    EnvironmentInitialConditions,
    ...
    TopologyOutcomeConstraintFormula,
    TopologyFairnessConditionsFormula,
    TopologyOutcomePersistenceFormula,
    SimpleLivenessRequirementActOutFormula,
    )
...
class ActionFormulaGenerationTests(unittest.TestCase):
    ...
    def test_action_fairness_conditions_multiple_outcomes(self):
        ...
        expected_formula = '(' + expected_formula_1a + ' | ' + '! dance_a' + ')'
...
class TSFormulaGenerationTests(unittest.TestCase):
    ...
    def test_single_step_change_formula_with_multiple_outcomes(self):
        ...
        expected_formula_1b = ('(r1_c & (r2_a & ! r1_a & ! r3_a)) -> '
                               '(next(r1_c) | next(r2_f) | next(r2_c))')

        expected_formula_1c = ('(r1_c & (r3_a & ! r1_a & ! r2_a)) -> '
                               '(next(r3_c) | next(r3_f) | next(r1_c))')

        expected_formula_2 = '(r2_c & (r2_a & ! r1_a & ! r3_a)) -> (next(r2_f) | next(r2_c))'

        expected_formula_3a = ('(r3_c & (r1_a & ! r2_a & ! r3_a)) -> '
    ...
    def test_topology_fairness_conditions_single_outcome(self):
        ...
        #                          expected_formula_2 + ' | ' + \
        #                          expected_formula_3 + ')'
        expected_formula = '(' + expected_formula_1 + ' | ' + expected_formula_3 + ')'
