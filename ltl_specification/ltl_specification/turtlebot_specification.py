...
class CompleteSpecification(GR1Specification):
    ...
    def __init__(self, name, initial_conditions, goals,
        ...
        self.logger = rclpy.logger.get_logger('turtlebot_specification')
        ...
        self.logger.error('Hit')
        # Load control modes and action preconditions from config file
        simple_config = RobotConfiguration('turtlebot')
        ...
        # This is causing the error, without this the synthesis
        # is unrealizable in the current configuration
        print('hit')
