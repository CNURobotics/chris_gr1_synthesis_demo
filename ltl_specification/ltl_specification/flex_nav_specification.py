...
class CompleteSpecification(GR1Specification):
    ...
    def __init__(self, name, initial_conditions, goals,
                 ...
                 strict_order=True):
        self.logger = rclpy.logging.get_logger('flex_nav_specification')
        ...
        simple_config = RobotConfiguration('flex_nav')
        ...
        # without this the synthesis is unrealizable in the current configuration
        print('hit')
