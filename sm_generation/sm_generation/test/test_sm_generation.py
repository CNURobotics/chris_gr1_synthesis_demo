...
from ..sm_generation_server import generate_sm
from synthesis_msgs.srv import GenerateFlexBESMRequest
from synthesis_msgs.msg import (
    SynthesisErrorCodes,
    FSAutomaton,
    AutomatonState
)
...
def load_synthesized_automaton(fpath):
    ...
    Preconditions:
        ...
        grasp:
            - manipulate
    """
    # FIXME: Remove dependency on ROOT_DIR
    yaml_file = os.path.join(repo, fpath)
...
class TestGenerateFlexBESM(unittest.TestCase):
    ...
    """
    def setUp(self):
        fpath = 'catkin_ws/src/behavior_synthesis/sm_generation/' +\
                'src/sm_generation/test/test_sm_gen_request_multiple_output.yaml'
        # fpath = 'catkin_ws/src/behavior_synthesis/sm_generation/'+\
        #        'src/sm_generation/test/test_sm_gen_request.yaml'
        (self.out_vars, self.in_vars, self.automata) = load_synthesized_automaton(fpath)
